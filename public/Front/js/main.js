$(document).ready(function() {
    ...
    if (document.getElementById("home-counter-area")) {
        $('.counter').counterUp({
            delay: 10,
            time: 1000
        });
   ...
   //------- Filter  js --------//
    ...
    //------- Initiate superfish on nav menu  js --------//  
    ...
    //------- Smooth scroll for the menu and links with .scrollto classes js --------//  
    ...
    $('.home-active-testimonial').owlCarousel({
        items: 2,
        loop: true,
        margin: 30,
        dots: true,
