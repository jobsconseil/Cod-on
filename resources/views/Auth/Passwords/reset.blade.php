        ...
        <div class="row justify-content-center pb-30">
            <div class="col-lg-6 col-lg-offset-3">
                <div class="section-title text-center">
                    <h1 class="mb-10">Réinitialisation du Mot de Passe</h1>
                    <span></span>
                </div>
            </div>
        </div>
                ...
                <div class="card-container">
                    ...
                    <form class="form-signin" method="post" action="{{ route('password.request') }}">
                        ...
                        @if( $errors->has('email'))
                            ...
                            @endcomponent
                        @endif
                        <label class="text-uppercase pt-10" for="password">Nouveau Mot de Passe</label>
                        ...
                        @if( $errors->has('passord'))
                            ...
                            @endcomponent
                        @endif
                        <label class="text-uppercase pt-10" for="password">Confirmer Mot de Passe</label>
                        <input type="password" name="password_confirmation" id="inputPassword" class="form-control" placeholder="Mot de Passe" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Mot de Passe'" required>
